...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public static final String TYPE_DAILY_REMAINDER = "DailyRemainder";
    public static final String EXTRA_MESSAGE = "message";
    public static final String EXTRA_TYPE = "type";

     final int ID_DAILY_REMAINDER = 100;
    ...
    public void setAlarmDailyReminder(Context context, String type ){

        AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        Intent intent = new Intent(context, AlarmReceiver.class);
        intent.putExtra(EXTRA_MESSAGE, "Cataloge Movie Missing You");
