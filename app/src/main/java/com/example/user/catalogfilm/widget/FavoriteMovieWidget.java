...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = " com.example.user.catalogfilm.TOAST_ACTION";
    public static final String EXTRA_ITEM = " com.example.user.catalogfilm.EXTRA_ITEM";
